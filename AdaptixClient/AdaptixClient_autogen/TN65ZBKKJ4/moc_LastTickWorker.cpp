...
#include "../../Headers/Client/LastTickWorker.h"
...
static constexpr auto qt_meta_stringdata_ZN14LastTickWorkerE = QtMocHelpers::stringData(
    "LastTickWorker",
    "updateLastItems",
    ""
);
...
Q_CONSTINIT static const uint qt_meta_data_ZN14LastTickWorkerE[] = {
...
Q_CONSTINIT const QMetaObject LastTickWorker::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN14LastTickWorkerE.offsetsAndSizes,
    qt_meta_data_ZN14LastTickWorkerE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN14LastTickWorkerE_t,
        // Q_OBJECT / Q_GADGET
...
void LastTickWorker::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: _t->updateLastItems(); break;
        default: ;
        }
    }
    (void)_a;
...
void *LastTickWorker::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN14LastTickWorkerE.stringdata0))
