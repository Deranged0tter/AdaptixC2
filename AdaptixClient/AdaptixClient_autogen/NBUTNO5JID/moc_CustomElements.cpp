...
static constexpr auto qt_meta_stringdata_ZN9SpinTableE = QtMocHelpers::stringData(
    "SpinTable"
);
...
Q_CONSTINIT static const uint qt_meta_data_ZN9SpinTableE[] = {
...
Q_CONSTINIT const QMetaObject SpinTable::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN9SpinTableE.offsetsAndSizes,
    qt_meta_data_ZN9SpinTableE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN9SpinTableE_t,
        // Q_OBJECT / Q_GADGET
...
void *SpinTable::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN9SpinTableE.stringdata0))
...
#ifdef QT_MOC_HAS_STRINGDATA
static constexpr auto qt_meta_stringdata_ZN12FileSelectorE = QtMocHelpers::stringData(
    "FileSelector"
);
#else  // !QT_MOC_HAS_STRINGDATA
#error "qtmochelpers.h not found or too old."
...
Q_CONSTINIT static const uint qt_meta_data_ZN12FileSelectorE[] = {
...
Q_CONSTINIT const QMetaObject FileSelector::staticMetaObject = { {
    QMetaObject::SuperData::link<QWidget::staticMetaObject>(),
    qt_meta_stringdata_ZN12FileSelectorE.offsetsAndSizes,
    qt_meta_data_ZN12FileSelectorE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN12FileSelectorE_t,
        // Q_OBJECT / Q_GADGET
        QtPrivate::TypeAndForceComplete<FileSelector, std::true_type>
    >,
    nullptr
} };
...
{
    if (!_clname) return nullptr;
    if (!strcmp(_clname, qt_meta_stringdata_ZN12FileSelectorE.stringdata0))
        return static_cast<void*>(this);
    return QWidget::qt_metacast(_clname);
}
