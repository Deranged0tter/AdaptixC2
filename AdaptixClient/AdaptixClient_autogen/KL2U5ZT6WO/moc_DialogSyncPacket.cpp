...
static constexpr auto qt_meta_stringdata_ZN18CustomSplashScreenE = QtMocHelpers::stringData(
    "CustomSplashScreen"
);
...
Q_CONSTINIT static const uint qt_meta_data_ZN18CustomSplashScreenE[] = {
...
Q_CONSTINIT const QMetaObject CustomSplashScreen::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN18CustomSplashScreenE.offsetsAndSizes,
    qt_meta_data_ZN18CustomSplashScreenE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN18CustomSplashScreenE_t,
        // Q_OBJECT / Q_GADGET
...
void *CustomSplashScreen::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN18CustomSplashScreenE.stringdata0))
