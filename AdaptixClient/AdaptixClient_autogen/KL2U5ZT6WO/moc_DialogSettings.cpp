...
static constexpr auto qt_meta_stringdata_ZN14DialogSettingsE = QtMocHelpers::stringData(
    "DialogSettings",
    "onStackChange",
    "",
    "index"
...
Q_CONSTINIT static const uint qt_meta_data_ZN14DialogSettingsE[] = {
...
Q_CONSTINIT const QMetaObject DialogSettings::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN14DialogSettingsE.offsetsAndSizes,
    qt_meta_data_ZN14DialogSettingsE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN14DialogSettingsE_t,
        // Q_OBJECT / Q_GADGET
...
void *DialogSettings::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN14DialogSettingsE.stringdata0))
